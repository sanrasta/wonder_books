...
export default function BirthdayBookPreview() {
  const [currentPage, setCurrentPage] = useState(0);

  const pages = [
    {
      title: "The Birthday Adventure",
      subtitle: "A Special Day Awaits",
      pageImage: "https://images.unsplash.com/photo-1464349153735-7db50ed83c84?w=800&auto=format&fit=crop&q=60",
    },
    {
      title: "Chapter One:\nThe Morning Surprise",
      subtitle: "Something magical is about to happen",
      pageImage: "https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=800&auto=format&fit=crop&q=60",
    },
    {
      title: "Chapter Two:\nThe Party Begins",
      subtitle: "Friends gather from near and far",
      pageImage: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&auto=format&fit=crop&q=60",
    },
    {
      title: "Chapter Three:\nThe Wish",
      subtitle: "Close your eyes and make a wish",
      pageImage: "https://images.unsplash.com/photo-1513151233558-d860c5398176?w=800&auto=format&fit=crop&q=60",
    },
  ];
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 text-center relative">
        ...
        >
          <h3 className="text-3xl md:text-4xl font-bold font-fredoka text-amber-900 mb-4">
            Preview Your Birthday Book
          </h3>
          <p className="text-lg text-amber-700 max-w-2xl mx-auto">
            Each book is beautifully illustrated with birthday magic, party fun, and personalized adventures.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 text-amber-800">
          <div className="flex flex-col items-center">
            ...
            <span className="text-sm text-amber-600">Full of birthday fun</span>
          </div>
          <div className="flex flex-col items-center">
            <span className="text-4xl mb-2">🎁</span>
            <span className="font-bold text-lg">Gift Ready</span>
            <span className="text-sm text-amber-600">Beautiful packaging</span>
          </div>
          <div className="flex flex-col items-center">
            <span className="text-4xl mb-2">🎨</span>
