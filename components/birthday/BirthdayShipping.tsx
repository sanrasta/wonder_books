...
export default function BirthdayShipping() {
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 text-center relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-amber-100 px-4 py-2 rounded-full mb-4 border border-amber-200 text-amber-700 font-fredoka text-sm">
            <span className="text-xl">🎁</span> Birthday Special
          </div>
          <h3 className="text-3xl md:text-4xl font-bold font-fredoka text-amber-900 mb-4">
            Delivered Before the Big Day
          </h3>
          <p className="text-lg text-amber-700 max-w-2xl mx-auto">
            We offer rush shipping to make sure your personalized birthday book arrives in time for the celebration.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="flex items-center gap-4 bg-amber-100 p-4 rounded-xl border border-amber-200">
              ...
              <div>
                <h4 className="font-bold text-amber-900 text-lg">Perfect Birthday Gift!</h4>
                <p className="text-amber-700 text-sm">A unique keepsake they'll treasure forever.</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-amber-800">Rush Birthday Delivery</p>
                    <p className="text-sm text-amber-600">2-3 business days</p>
                  </div>
                </div>
                <span className="font-bold text-amber-900">+$12.99</span>
              </div>
              <div className="flex items-center justify-between p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                <div className="flex items-center gap-3">
                  <span className="text-2xl">📦</span>
              ...
              <div className="flex items-center justify-between p-4 bg-amber-100 rounded-xl shadow-sm border border-amber-200">
                <div className="flex items-center gap-3">
                  <span className="text-2xl">🎁</span>
                  <div>
                    <p className="font-semibold text-amber-800">Gift Wrapping</p>
                    <p className="text-sm text-amber-600">Birthday-themed packaging</p>
                  </div>
                </div>
                <span className="font-bold text-amber-900">+$4.99</span>
              </div>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full bg-gradient-to-r from-amber-500 to-orange-500 text-white px-8 py-4 rounded-full text-lg font-bold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2"
            >
